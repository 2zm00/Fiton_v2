...
class Review(models.Model):
    ...
    lesson_review = models.ForeignKey(Lesson, on_delete=models.CASCADE, related_name='reviews',verbose_name="수업")
    ...
    def __str__(self):
        return f"{self.member.user.name} - {self.lesson_review.name} ({self.rating})"
